...
const boardMembers = [
    {
        name: "Venkataraman Seshadri",
        alias: "{applemango}",
        role: "Team Leader",
        avatar: "assets/board-photos/26-27/venkat-leader.webp",
        linkedin: "https://www.linkedin.com/in/venkat-sesh/",
        github: "https://github.com/AppleMangoOrange",
        instagram: "",
        quote: "{applemango}",
        domains: ["Cryptography", "Reverse Engineering", "Attack/Defense", "Hardware Security"]
    },
    {
        name: "Isha Sarvani Telikicherla",
        alias: "{randoduck}",
        role: "Team Manager",
        avatar: "assets/board-photos/26-27/isha-manager.webp",
        linkedin: "https://www.linkedin.com/in/isha-sarvani-8b3735266/",
        github: "https://github.com/randoduck",
        instagram: "",
        quote: "{randoduck}",
        domains: ["Management", "Research", "AI"]
    },
    {
        name: "Anshuman Shukla",
        alias: "{vitruvian}",
        role: "Hardware Security Head",
        avatar: "assets/board-photos/26-27/anshuman-hardware.webp",
        linkedin: "",
        github: "https://github.com/07anshuman",
        instagram: "",
        quote: "{vitruvian}",
    ...
    },
    {
        ...
        avatar: "assets/board-photos/26-27/devansh-webex.webp",
        linkedin: "https://www.linkedin.com/in/devansh-d-659036184/",
        github: "https://github.com/Devansh-lelouch",
        instagram: "",
        quote: "{kafka}",
        domains: ["Web Exploitation", 'Attack/Defense', 'Digital Forensics']
    },
    {
        name: "Devansh Tandon",
        alias: "{void_obsidian}",
        role: "Research Head",
        avatar: "assets/board-photos/26-27/devansh-research.webp",
        linkedin: "https://www.linkedin.com/in/devansh-tandon-546335340/",
        github: "https://github.com/voidObsidian",
        instagram: "",
        quote: "{void_obsidian}",
        domains: ["Research", "AI"]
    },
    {
        name: "Devarjya Purkayastha",
        alias: "{indrath}",
        role: "Forensics Head",
        avatar: "assets/board-photos/26-27/devarjya-forensics.webp",
        linkedin: "https://www.linkedin.com/in/devarjya/",
        github: "https://github.com/devarjya27",
        instagram: "",
        quote: "{indrath}",
        domains: ["Digital Forensics", "Reverse Engineering", "Attack/Defense"]
    },
    {
        name: "Kenneth Rodrigues",
        alias: "{goosbo}",
        role: "Cryptography Head",
        avatar: "assets/board-photos/26-27/kenneth-crypto.webp",
        linkedin: "https://www.linkedin.com/in/kennrodri/",
    ...
    },
    {
        ...
        avatar: "assets/board-photos/26-27/satwik-binex.webp",
        linkedin: "https://www.linkedin.com/in/satwik-hegde-b0729b32a/",
        github: "https://github.com/LeviathanAG",
        instagram: "",
        quote: "{dantalian}",
        domains: [ "Binary Exploitation", "Web Exploitation"]
    },
    {
        name: "Shaan Chopra",
        alias: "{iateurcake}",
        role: "AI Head",
        avatar: "assets/board-photos/26-27/shaan-ai.webp",
        linkedin: "https://www.linkedin.com/in/shachopr/",
        github: "https://github.com/freebirdyeah",
        instagram: "",
        quote: "{iateurcake}",
        domains: ["AI", "Research"]
    },
    {
        ...
        avatar: "assets/board-photos/26-27/suraj-reverse.webp",
        linkedin: "https://www.linkedin.com/in/suraj-dhondale/",
        github: "https://github.com/findshady",
        instagram: "",
        quote: "{shady}",
        domains: ["Reverse Engineering", "Digital Forensics"]
    },
    {
        name: "Tia Cibi Thomas",
        alias: "{teayah}",
        role: "Management Head",
        avatar: "assets/board-photos/26-27/tia-management.webp",
        linkedin: "https://www.linkedin.com/in/tiacthomas/",
        github: "https://github.com/teayahz",
        instagram: "",
        quote: "{teayah}",
        domains: ["Management", "Cryptography", "Digital Forensics"]
    },
];

const boardMembers3rdYear = [
    { name: "Aaron Fritz",           alias: "{arnftz}",                 avatar: "", linkedin: "", github: "", instagram: "" },
    { name: "Arun Anand",            alias: "{blueknight2345}",         avatar: "", linkedin: "", github: "", instagram: "" },
    { name: "Neha Varadharajan",     alias: "{nayhah}",                 avatar: "", linkedin: "", github: "", instagram: "" },
    { name: "Pratham Shah",          alias: "{attentionisallineed}",    avatar: "", linkedin: "", github: "", instagram: "" },
    { name: "Sambhavit Anand",       alias: "{guitaristsam}",           avatar: "", linkedin: "", github: "", instagram: "" },
    { name: "Shakthi Rohan R",       alias: "{dunruh}",                 avatar: "", linkedin: "", github: "", instagram: "" },
    { name: "Shreyas Nayak",         alias: "{chinappaswami}",          avatar: "", linkedin: "", github: "", instagram: "" },
    { name: "Shrikrishna Bhaktha",   alias: "{explioit3r}",             avatar: "", linkedin: "", github: "", instagram: "" }
...
const achievements = {
    ...
    hackathons: [
        ...
        { event: "HACK IITK 2026",                        result: "2nd Place", prize: "2,00,000 INR",                  date: "April 2026",    link: "https://www.linkedin.com/posts/hackiitk2026-cybersecurity-winners-ugcPost-7449399706834718720-pe03/" },
...
const alumniData = [
    ...
    { name: "Bhavya Sharma",            batch: "2021", current: "Simon Fraser University",              position: "team leader",              linkedin: "https://www.linkedin.com/in/bhvya1505/" },
    { name: "Numan Zaheer Ahmed",       batch: "2021", current: "Arista Networks",                     position: "technical head",           linkedin: "https://www.linkedin.com/in/anutrix" },

    { name: "Aman Priyanshu",           batch: "2023", current: "Foundation AI", position: "technical head",           linkedin: "https://www.linkedin.com/in/aman-priyanshu/" },
    { name: "Cynthia Maria Dsouza",     batch: "2023", current: "Carnegie Mellon University",         position: "team manager",             linkedin: "https://www.linkedin.com/in/cynthia-maria-dsouza/" },
    { name: "Haseeb Khalid",            batch: "2023", current: "New Jersey Institute of Technology",            position: "web exploitation head",    linkedin: "https://www.linkedin.com/in/haseebkhalid1507/" },
    ...
    { name: "Rajat Agarwal",            batch: "2023", current: "Anthral Labs",                 position: "attack/defense head",      linkedin: "https://www.linkedin.com/in/rajat18agarwal/" },
    { name: "Sai Charan Teja Ande",     batch: "2023", current: "Cisco",                      position: "-",                        linkedin: "https://www.linkedin.com/in/sai-charan-teja-ande/" },
    { name: "Sohom Datta",              batch: "2023", current: "North Carolina State University",                position: "reverse engineering head", linkedin: "https://www.linkedin.com/in/sohom-datta-c29ob20k/" },
    ...
    { name: "Rayhan Faizel",            batch: "2024", current: "University of Pennsylvania",             position: "binary exploitation head", linkedin: "https://www.linkedin.com/in/rayhan-f-2933281b3/" },
    { name: "Rohan Vinod Pol",          batch: "2024", current: "Google",                     position: "-",                        linkedin: "https://www.linkedin.com/in/rohan2182/" },

    { name: "Aditi Kulkarni",           batch: "2025", current: "Docusign",                       position: "research head",            linkedin: "https://www.linkedin.com/in/aditi-kulkarni-393568229/" },
    ...
    { name: "Shreyansh Sankrit",        batch: "2025", current: "Rystad Energy",               position: "team leader",              linkedin: "https://www.linkedin.com/in/shreyansh-sankrit/" },
    { name: "Shreyas BS",               batch: "2025", current: "Anki Technologies",                       position: "networking head",          linkedin: "https://www.linkedin.com/in/shreyas1860/" },
    { name: "Siddharth Mittal",         batch: "2025", current: "IIM Mumbai",                     position: "forensics head",           linkedin: "https://www.linkedin.com/in/siddharth-mittal-/" },
    ...
    { name: "Avanish Money Srivats",    batch: "2026", current: "FYNDNA",                        position: "research head",            linkedin: "https://www.linkedin.com/in/avanish-money-srivats-9bb362234/" },
    { name: "Ansh Goyal",               batch: "2026", current: "Dassault Systèmes",          position: "team manager",             linkedin: "https://www.linkedin.com/in/ansh-goyal/" },
    { name: "Gurmann Ajmani",           batch: "2026", current: "Coverstack",                     position: "ai head",                  linkedin: "https://www.linkedin.com/in/gurmann-singh-ajmani-a80a31262/" },
    ...
    { name: "Rupak Banerjee",           batch: "2026", current: "breachx",            position: "web exploitation head",    linkedin: "https://www.linkedin.com/in/rupak-banerjee-61509727b/" },
    { name: "Tanmay Saxena",            batch: "2026", current: "Bottomline",                position: "cryptography head",        linkedin: "https://www.linkedin.com/in/tanmay-saxena-76aa85274/" },
    { name: "Uday Ojha",                batch: "2026", current: "Eli Lilly and Company",                   position: "reverse engineering Head", linkedin: "https://www.linkedin.com/in/uday-o/" },
